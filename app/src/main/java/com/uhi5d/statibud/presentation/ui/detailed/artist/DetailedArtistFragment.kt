...
import com.uhi5d.statibud.databinding.FragmentDetailedArtistBinding
...
import com.uhi5d.statibud.presentation.ui.detailed.ARTIST_URI
import com.uhi5d.statibud.presentation.ui.detailed.DetailedViewModel
import com.uhi5d.statibud.presentation.ui.detailed.album.toDetailedAlbumFragmentModel
...
class DetailedArtistFragment : Fragment(),
    ...
    private fun init(artist: Artist){
        with(binding){
            ...
            iv.loadWithPicasso(artist.images!![0].url)
        }
